...
public class RegisterFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mBinding.textviewIHaveAccount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
...
//    }
    ...
    private boolean validateForm() {
        ...
        if (!password.equals(retry_password)) {
            mBinding.passwordTextInput.setError(getString(R.string.retry_password_error_msg));
            valid = false;
        } else {
            mBinding.passwordTextInput.setError(null);
        }
